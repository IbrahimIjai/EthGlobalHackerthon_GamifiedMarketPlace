              ...
              if (chain.unsupported || chain.id !== configuredNetwork.id) {
                return (
                  <div className="dropdown dropdown-end">
                    ...
                    <ul
                      tabIndex={0}
                      className="dropdown-content menu p-2 mt-1 shadow-center shadow-accent bg-muted rounded-box gap-1"
                    >
                      <li>
                        <button
              ...
              return (
                <div className="px-2 flex justify-end items-center">
                  ...
                  <div className="dropdown dropdown-end leading-3">
                    ...
                    <ul
                      tabIndex={0}
                      className="dropdown-content menu z-[2] p-2 mt-2 shadow-center shadow-accent bg-muted rounded-box gap-1"
                    >
                      <li>
                        {addressCopied ? (
