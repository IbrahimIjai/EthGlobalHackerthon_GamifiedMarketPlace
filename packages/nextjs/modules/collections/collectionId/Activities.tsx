...
export default function Activities() {
  return (
    <div className="mt-4 col-span-2 w-full">
      <h1 className="title_h1 mx-3 my-6">Activites</h1>
      <div className="w-full  flex items-center justify-center opagbg">
        <p className="text-gray-300 font-bold text-xl">Coming soon</p>
      </div>
    </div>
  );
}
...
const Cards = () => {
  return (
    <Link href="" className="flex cursor-pointer items-center w-full justify-between p-6 hover:bg-muted easytransition">
      <p>2H</p>
      ...
      <div className="bg-muted flex P-1 gap-1 ">
